...
#include "TestProject/MyScripts/FP_FirstPersonCharacter.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	TESTPROJECT_API UClass* Z_Construct_UClass_AFP_FirstPersonCharacter_NoRegister();
	TESTPROJECT_API UClass* Z_Construct_UClass_AFP_FirstPersonCharacter();
...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AFP_FirstPersonCharacter_Statics::Class_MetaDataParams[] = {
		...
		{ "IncludePath", "MyScripts/FP_FirstPersonCharacter.h" },
		{ "ModuleRelativePath", "MyScripts/FP_FirstPersonCharacter.h" },
	};
#endif
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(AFP_FirstPersonCharacter, 4072145386);
	template<> TESTPROJECT_API UClass* StaticClass<AFP_FirstPersonCharacter>()
	{
		return AFP_FirstPersonCharacter::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_AFP_FirstPersonCharacter(Z_Construct_UClass_AFP_FirstPersonCharacter, &AFP_FirstPersonCharacter::StaticClass, TEXT("/Script/TestProject"), TEXT("AFP_FirstPersonCharacter"), false, nullptr, nullptr, nullptr);
